...
class FotosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create foto" do
    assert_difference("Foto.count") do
      post fotos_url, params: { foto: { nome_arquivo: @foto.nome_arquivo, servico_id: @foto.servico_id, titulo: @foto.titulo, token: @foto.token } }
    end
  ...
  test "should update foto" do
    patch foto_url(@foto), params: { foto: { nome_arquivo: @foto.nome_arquivo, servico_id: @foto.servico_id, titulo: @foto.titulo, token: @foto.token } }
