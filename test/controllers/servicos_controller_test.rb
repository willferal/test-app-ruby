...
class ServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servico" do
    assert_difference("Servico.count") do
      post servicos_url, params: { servico: { entidade_id: @servico.entidade_id, observacoes: @servico.observacoes, tipo_servico_id: @servico.tipo_servico_id, vigencia_final: @servico.vigencia_final, vigencia_inicial: @servico.vigencia_inicial } }
    end
  ...
  test "should update servico" do
    patch servico_url(@servico), params: { servico: { entidade_id: @servico.entidade_id, observacoes: @servico.observacoes, tipo_servico_id: @servico.tipo_servico_id, vigencia_final: @servico.vigencia_final, vigencia_inicial: @servico.vigencia_inicial } }
